...
const TranslatorBox = () => {
  ...
  // Debounce function for translation with 1.5 second delay
  useEffect(() => {
    if (spanishText === "") {
      setZapotecText("")
      setDebouncedText("")
    ...
    }, 1500) // 1.5 seconds debounce as requested
  ...
  const handleTranslate = async (text: string) => {
    ...
    try {
      ...
      // Corregido: usar la propiedad correcta del objeto de respuesta
      setZapotecText(data.translation)
    } catch (err) {
